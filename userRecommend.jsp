...
.style15 {color: #FFFFFF; font-size: 14px; font-weight: bold; }
-->
</style>
</head>
<body>
...
String fname=rs1.getString("username");
  ...
  <div align="center" class="style1">  
    ...
    <table width="465" border="0">
      <tr>
        <td width="245" bgcolor="#FF0000"><div align="center" class="style8 style13">Topic ID </div></td>
        <td width="210"><label>
          <input type="text" name="t1" value="<%=i%>" readonly>
        </label></td>
      </tr>
      <tr>
        <td bgcolor="#FF0000"><div align="center" class="style15">Topic Name </div></td>
        <td><label>
          <input type="text" name="t2" value="<%=s3%>" readonly>
        </label></td>
      </tr>
      <tr>
        <td bgcolor="#FF0000"><div align="center" class="style15">Select the User to Recommend </div></td>
        <td><label>
          <select name="t3">
      ...
      <tr>
        <td bgcolor="#FF0000"><div align="center" class="style15">Details</div></td>
