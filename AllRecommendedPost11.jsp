...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style5"><a href="index.html" class="style6">DCCR Deep Collaborative Conjunctive Recommender for Rating Prediction</a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
...
%>
 ...
 <table width="635" border="1"  cellpadding="0" cellspacing="0"  >
   <tr>
   ...
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Product ID </div></td>
     <td width="175"><span class="style15"> &nbsp;&nbsp;<%=i%></span></td>
   </tr>
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Product Name </div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=name%></span></td>
   </tr>
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Recommended From </div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=from%></span></td>
   </tr>
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Recommended To </div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=to%></span></td>
   </tr>
   
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style10" style="margin-left:20px;">Date</div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=date%></span></td>
   </tr>
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style10" style="margin-left:20px;">Recommended Details</div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=details%></span></td>
   </tr>
   <tr>
     <td  width="206" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Rating </div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=j%></span></td>
   </tr>
   <tr>
     <td   width="206" height="62" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10" style="margin-left:20px;">Rating of Pro </div                        ></td>
