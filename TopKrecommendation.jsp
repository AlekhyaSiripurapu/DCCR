    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
         <form id="form1" name="form2" method="post" action="TopKrecommendation1.jsp">
           <table width="435" border="0" align="center">
             <tr>
               <th width="189" height="44" bgcolor="#FF0000" scope="col"><span class="style10">Top 'K' Value  </span></th>
               <th width="230" scope="col"><div align="center">
                 <label>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li></li>
            <li><a href="UserMain.jsp">User Main</a><a href="UserProfile.jsp"> <br />
            </a></li>
