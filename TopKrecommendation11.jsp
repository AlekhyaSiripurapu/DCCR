...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style6">DCCR Deep Collaborative Conjunctive Recommender for Rating Prediction</a><a href="index.html"></a></h1>
      </div>
...
%>
  ...
  <tr>
    <td width="203" height="30" bgcolor="#FF0000"><div align="left" class="style10 style7"><strong>Product Name</strong></div></td>
    <td width="222"><span class="style15"><%=s2%></span></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Product Color </strong></div></td>
    <td><span class="style15"><%=s3%></span></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Product Description </strong></div></td>
    <td><span class="style15"><%=s4%></span></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>uses</strong></div></td>
    <td><span class="style15"><%=s5%></span></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Location</strong></div></td>
    <td><span class="style15"><%=s6%></span></td>
  </tr>

  <tr>
    <td height="141" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Product Images </strong></div></td>
   ...
   <tr>
    <td height="30" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Rank</strong></div></td>
    <td><span class="style15"><%=j%></span></td>
  </tr>
  <tr>
    <td height="40" bgcolor="#FF0000"><div align="left" class="style10 style7 style14"><strong>Ratings of Prouct </strong></div></td>
