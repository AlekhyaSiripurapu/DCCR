...
.style19 {color: #FFFF00; font-size: 14px; font-weight: bold; }
-->
</style>
</head>
<body>
<div class="main style3">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style5"><a href="index.html" class="style6">DCCR Deep Collaborative Conjunctive Recommender for Rating Prediction
</a></h1>
      </div>
    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <table width="552" border="1" align="center"  cellpadding="0" cellspacing="0"  >
            <tr>
              <th width="51" bgcolor="#FF0000" scope="col"><span class="style19">SI NO </span></th>
              <th width="174" bgcolor="#FF0000" scope="col"><span class="style19">UserName</span></th>
              <th width="172" bgcolor="#FF0000" scope="col"><span class="style19">Keyword</span></th>
              <th width="145" bgcolor="#FF0000" scope="col"><span class="style19">Date &amp; Time </span></th>
            </tr>
