...
%>
 ...
 <table width="574" border="1" align="center"  cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td  width="144" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style11" style="margin-left:20px;">Product ID </div></td>
     <td width="176"><span class="style15"> &nbsp;&nbsp;<%=i%></span></td>
   </tr>
   <tr>
     <td  width="144" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style11" style="margin-left:20px;">Product Name </div></td>
   ...
   <tr>
     <tr>
     <td  width="144" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style11" style="margin-left:20px;">Total Rank </div></td>
     <td><span class="style15">&nbsp;&nbsp;<%=j%></span></td>
   </tr>
   <tr>
     <td   width="144" height="62" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style11" style="margin-left:20px;">Rating of Pro </div                        ></td>
    ...
    %>
       ...
       <tr>
     <td  width="144" height="41" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style11" style="margin-left:20px;">Reviewed By</div></td>
     <td  width="144" height="41" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11" style="margin-left:20px;">Reviewed Details</div></td>
	  <td  width="144" height="41" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11" style="margin-left:20px;">Date</div></td>
   </tr>
   <%
