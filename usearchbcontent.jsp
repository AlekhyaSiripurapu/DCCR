            ...
            <FORM ACTION="usearchbcontent.jsp" METHOD="post">
                ...
                <DIV STYLE="width:600px;">
                  <TABLE ALIGN="center" STYLE="margin:0 0 0 30px;">
                    <TR>
                      <TD bgcolor="#FF00FF"><P class="style10">USER  KEYWORD&nbsp;&nbsp;</P></TD>
                      <TD bgcolor="#FF00FF"><INPUT name="keyword" TYPE="text" /></TD>
                      <TD bgcolor="#FF00FF"><INPUT name="submit" TYPE="submit" STYLE="width:50px; height:25px;" VALUE="GO"/></TD>
                    </TR>
                    <TR>
                      <TD COLSPAN="3" bgcolor="#FF00FF"><P class="style10">[ searching content Based on Image Description ] </P></TD>
                    </TR>
                  </TABLE>
                </DIV>
